...
URLS = {
    ...
    ("3.7", "32"): BASE_URL + "3.7.6/python-3.7.6.exe",
    ("3.8", "64"): BASE_URL + "3.8.1/python-3.8.1-amd64.exe",
    ("3.8", "32"): BASE_URL + "3.8.1/python-3.8.1.exe",
}
INSTALL_CMD = {
    ...
    "3.7": [["msiexec.exe", "/L*+!", "install.log", "/qn", "/x", "{path}"],
            ["msiexec.exe", "/L*+!", "install.log", "/qn", "/i", "{path}",
             "TARGETDIR={home}"]],
    "3.8": [["msiexec.exe", "/L*+!", "install.log", "/qn", "/x", "{path}"],
            ["msiexec.exe", "/L*+!", "install.log", "/qn", "/i", "{path}",
             "TARGETDIR={home}"]],
}
